...
\@x{}\moduleLeftDash\@xx{ {\MODULE} DanielEuclid}\moduleRightDash\@xx{}%
\@x{ {\EXTENDS} Integers ,\, DanielGCD ,\, TLC}%
\@x{ {\CONSTANTS} M ,\, N}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
 \ensuremath{\.{\,\backslash\,}} is the set difference operator
}%
\@xx{}%
...
\@x{\@s{16.4}}%
\@y{\@s{0}%
 variables \ensuremath{x \.{=} M}, \ensuremath{y \.{=} N} ;
}%
\@xx{}%
 \@x{\@s{16.4} {\p@variables} x \.{\in} 1 \.{\dotdot} N ,\, y\@s{13.76}
 \.{\in} 1 \.{\dotdot} N ,\, x0 \.{=} x ,\, y0 \.{=} y {\p@semicolon}}%
\@y{\@s{0}%
 page 39 to test \ensuremath{Euclid}\mbox{'}s algorithm for values
...
\@xx{}%
 ...
 y\@s{0.10} \.{-} x {\p@rbrace}}%
 \@x{\@s{111.11} {\p@else}\@s{24.59} {\p@lbrace} x\@s{9.09} \.{:=} x \.{-} y
 {\p@rbrace}}%
\@x{\@s{101.53} {\p@rbrace} {\p@semicolon}}%
 \@x{\@s{25.98} {\p@assert} ( x \.{\neq} y ) \.{\land} ( x \.{=} GCD ( x0 ,\,
 y0 ) )}%
\@x{\@s{16.4} {\p@rbrace}}%
\@x{ {\p@rbrace}}%
\@y{}%
...
\@x{\@s{97.42} \.{\land} pc \.{'} \.{=}\@w{Lbl\_1}}%
 \@x{\@s{66.11} \.{\ELSE} \.{\land} Assert ( ( x \.{\neq} y ) \.{\land} ( x
 \.{=} GCD ( x0 ,\, y0 ) ) ,\,}%
\@x{\@s{141.12}\@w{Failure\ of\ assertion\ at\ line\ 16,\ column\ 7.} )}%
...
\@xx{}%
\@pvspace{8.0pt}%
 \@x{ PartialCorrectness \.{\defeq} ( pc \.{=}\@w{Done} ) \.{\implies}\@s{4.1}
 ( x \.{=} y ) \.{\land} ( x \.{=} GCD ( M ,\, N ) )}%
\@pvspace{8.0pt}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Oct} 12 17:39:18 \ensuremath{PDT} 2016 by \ensuremath{Daniel
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Wed} \ensuremath{Aug} 31
 17:24:26 \ensuremath{PDT} 2016 by \ensuremath{Daniel
}%
\end{cpar}%
\vshade{5.0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{\.{\,\backslash\,}}* Question 4.2 (page 34)
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Use set notation to write this assumption
 more compactly.
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{\.{\,\backslash\,}}* Answer:
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* \ensuremath{{\ASSUME} \{M,\, N\}
 \.{\subseteq} Nat \.{\,\backslash\,} \{0\}
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{\.{\,\backslash\,}}*
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{\.{\,\backslash\,}}* Question 4.3 (page 34)
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* How many other ways can you write the set of
 positive integers in TLA+\.{?}
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
\ensuremath{\.{\,\backslash\,}}* Answer:
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* \ensuremath{{\ASSUME}} \ensuremath{N \.{\in}
 \{x \.{\in} Nat \.{:} x \.{>} 0\}
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
